...
public class APIWorkflowSteps {
    ...
    public void a_request_is_prepared_to_create_an_employee_using_json_payload() {
        request = given().
                ...
                .body(APIPayloadConstant.createEmployeePayloadJson());
    }
    ...
    public void a_request_is_prepared_to_update_an_employee() {
        ...
        String query = "select employee_id from hs_hr_employees where emp_firstname ='TimoJado' and emp_lastname ='Dayouboo'";
        GlobalVariables.tabledata = DBUtility.getListOfMapsFromRset(query);

        String employee_idFromDB = GlobalVariables.tabledata.get(0).get("employee_id");
        System.out.println(employee_idFromDB);

        request = given().header(APIConstants.HEADER_KEY_CONTENT_TYPE,
                        APIConstants.HEADER_VALUE_CONTENT_TYPE).
                header(APIConstants.HEADER_KEY_AUTHORIZATION,
                        GenerateTokenSteps.token).
                body(APIPayloadConstant.updateEmployeePayloadJson());
...
// for get that employee...........................................
    ...
    @Then("the status code for get an employee is {int}")
    public void the_status_code_for_get_an_employee_is(Integer int1) {
        response.then().assertThat().statusCode(int1);
        response.prettyPrint();
     //   System.out.println(DBUtility.getResultSet("select employee_id from hs_hr_employees where emp_firstname ='TimoJado' and emp_lastname ='Dayouboo'"));
    }
}
